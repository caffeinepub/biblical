...
export class Backend implements backendInterface {
    ...
    async createStory(arg0: string, arg1: string, arg2: string, arg3: string): Promise<Story> {
        if (this.processError) {
            try {
    ...
    async getStoriesByAuthor(arg0: Principal): Promise<Array<Story>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStoriesByAuthor(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async likeStory(arg0: bigint): Promise<Story | null> {
        if (this.processError) {
            try {
...
function from_candid_opt_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Story]): Story | null {
    return value.length === 0 ? null : value[0];
}
